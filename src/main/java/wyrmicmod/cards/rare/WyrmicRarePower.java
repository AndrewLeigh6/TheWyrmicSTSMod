...
import wyrmicmod.powers.RarePower;

public class WyrmicRarePower extends CustomCard {
    ...
    public static final String ID = wyrmicmod.WyrmicMod.makeID("WyrmicRarePower");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager
                .addToBottom(new ApplyPowerAction(p, p, new RarePower(p, p, magicNumber), magicNumber));
    }
