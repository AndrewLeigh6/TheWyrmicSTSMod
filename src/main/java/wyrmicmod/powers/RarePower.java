...
public class RarePower extends AbstractPower {
    ...
    public static final String POWER_ID = wyrmicmod.WyrmicMod.makeID("RarePower");
    ...
    public void atStartOfTurn() { // At the start of your turn
        AbstractCard playCard = new WyrmicRareAttack(); // Declare Card
        ...
        // in this if statement, as it's just 1 line directly under. You can remove
        // them, if you want.

        AbstractDungeon.actionManager.addToBottom(new QueueCardAction(playCard, targetMonster)); // Play the card on the
                                                                                                 // target.
    }
