...
public class PlaceholderRelic2 extends CustomRelic {
    ...
    // ID, images, text.
    public static final String ID = wyrmicmod.WyrmicMod.makeID("PlaceholderRelic2");
    public static final String IMG = "WyrmicModResources/images/relics/placeholder_relic2.png";
    public static final String OUTLINE = "WyrmicModResources/images/relics/outline/placeholder_relic2.png";
